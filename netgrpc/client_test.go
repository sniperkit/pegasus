...
func TestNewClient(t *testing.T) {
	...
	client = netgrpc.NewClient("")
	_, err := client.Send(netgrpc.SetConf("path"), peg.BuildPayload(nil, nil))
...
func TestClient_Send(t *testing.T) {
	...
	payload, err := client.Send(netgrpc.SetConf("/Lucky/you/were/born"), peg.Payload{})
...
func TestClient_Send_failure(t *testing.T) {
	...
	_, err := client.Send(netgrpc.SetConf("/Lucky/you/were/born"), peg.Payload{})
